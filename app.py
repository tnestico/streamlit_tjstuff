...
styled_df = df[['pitcher_id', 'pitcher_name', 'pitch_type', 'pitches', 'tj_stuff_plus', 'pitch_grade']].to_pandas().style.background_gradient(subset=['tj_stuff_plus'], cmap='viridis')
